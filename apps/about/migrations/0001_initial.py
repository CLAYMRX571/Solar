    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ches_uz', models.CharField(max_length=100, null=True)),
                ('ches_en', models.CharField(max_length=100, null=True)),
                ('ches_kk', models.CharField(max_length=100, null=True)),
                ('ches_tg', models.CharField(max_length=100, null=True)),
                ('ches_tr', models.CharField(max_length=100, null=True)),
            ],
        ),
    ]
