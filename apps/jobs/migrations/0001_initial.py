    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('long_desc_uz', models.TextField(null=True)),
                ('long_desc_en', models.TextField(null=True)),
                ('long_desc_kk', models.TextField(null=True)),
                ('long_desc_tg', models.TextField(null=True)),
                ('long_desc_tr', models.TextField(null=True)),
            ],
        ),
    ]
